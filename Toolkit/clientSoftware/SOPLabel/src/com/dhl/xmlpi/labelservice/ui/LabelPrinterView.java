...
public class LabelPrinterView extends JFrame {
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle("XMLPI v6.0 Label Utility");
		...
		//======== labelPanel ========
		{
			...
			//======== panel6 ========
			{
				...
				//======== panel2 ========
				{
				    ...
				    panel2.add(this.label10, new TableLayoutConstraints(0, 9, 0, 9, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
				    panel2.add(this.hideAccount, new TableLayoutConstraints(1, 9, 1, 9, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
